...
void add_stack(stack_t **head, unsigned int number);
void every_stack(stack_t **head, unsigned int number);
...
void print_char_stack(stack_t **head, unsigned int counter);
